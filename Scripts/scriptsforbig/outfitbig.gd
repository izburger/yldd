...
func set_sprite_keys():
	outfit_keys = Global.outfit_collection_BIG.keys()

#update texture and modulate
func update_sprite():
	var current_sprite = outfit_keys[current_outfit_index]
	outfit_sprite.texture = Global.outfit_collection_BIG[current_sprite]
	#outfit_sprite.modulate = Global.colour_options[current_colour_index]
	
	Global.selected_outfit_BIG = current_sprite
